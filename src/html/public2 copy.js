(function() {
    ...
    Base.prototype = {
        ...
        tabs: function(options) {
            ...
            let div = $('.ul>li[data-type="tabs"]');

            let pic = $('.smallpic>img');
            let big = $('.big>img')
            ...
            btn.on(defaults.ev, function() {
                ...
                switch (_index) {
                    case 0:
                        pic[0].src = '../images/listgood1.jpg';
                        big[0].src = '../images/listgood1.jpg';
                        break;
                    case 1:
                        pic[0].src = '../images/listgood1-1.jpg';
                        big[0].src = '../images/listgood1-1.jpg';
                        break;
                    case 2:
                        pic[0].src = '../images/listgood2-1.jpg';
                        big[0].src = '../images/listgood2-1.jpg';
                        break;
                    case 3:
                        pic[0].src = '../images/listgood3-1.jpg';
                        big[0].src = '../images/listgood3-1.jpg';
                        break;
                    case 4:
                        pic[0].src = '../images/listgood4-1.jpg';
                        big[0].src = '../images/listgood4-1.jpg';
                        break;
                }
